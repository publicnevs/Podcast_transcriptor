/* PodScribe icon set — Lucide (ISC license), outline style.
   One consistent look across the app. Inline SVG so it works offline (no CDN).
   Usage: icon('play')  or  icon('trash-2', {size:18, cls:'danger'}) */
const ICONS = {
